...
const UpdatePat = () => {
  ...
  const [subMessage, setSubMessage] = useState("Add Treatment");
  ...
  return (
    <div className="w-full h-screen p-2">
      <div className=" h-[10vh] mb-10">
        <h2 className="text-5xl font-extrabold mb-5 ">Add Treatment</h2>
        <p className="">
          To apply for new treatment of already existing Patients.
        </p>
      </div>
      <ScrollArea className="h-5/6  border rounded-md ">
        <form className=" flex flex-col p-10 w-2/3" onSubmit={submit}>
